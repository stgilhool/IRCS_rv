pro template_caller_phoenixsmooth


model_tag='Jun30phoenixsmooth'
ircsrv_maketemplate_phoenixsmooth, visualize=0, first_pix=0L, npix_select=512L, min_type='amoeba', model_tag=model_tag



ircsrv_maketemplate_phoenixsmooth, visualize=0, first_pix=512L, npix_select=512L, min_type='amoeba', model_tag=model_tag
