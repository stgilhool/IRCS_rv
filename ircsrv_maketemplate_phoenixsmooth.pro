...
pro ircsrv_maketemplate_phoenix, epoch=epoch, object=object, trace=trace, visualize=visualize, first_pix=first_pix, npix_select=npix_select, min_type=min_type, lab_depth=lab_depth, norm=norm, model_tag=model_tag, telluric_option=telluric_option, template_start=template_start, chi2_tol=chi2_tol, smooth_opt=smooth_opt
...
if n_elements(template_start) eq 0 then template_start='../data/epoch/18Jan2011/temp_results/phoenix_template.fits'
