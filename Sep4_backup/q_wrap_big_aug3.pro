pro q_wrap_big_aug3, make_template=make_template
...
;;;EXTRA FOR BOTH
model_tag='newpipe'
model_out_tag='newpipe_mp1' ;FOR FITTING ONLY, ACTUALLY
...
if make_template then template_caller_aug3, _EXTRA=ex
...
q_wrap_aug3, first_first_pix=first_first_pix, pix_step=pix_step, model_out_tag=model_out_tag, _EXTRA=ex2
