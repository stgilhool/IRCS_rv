...
pro ircsrv_h2ofit1, epoch=epoch, object=object, trace=trace, visualize=visualize, first_pix=first_pix, npix_select=npix_select, mode=mode
...
for scaleiter=0, maxiter do begin
    ...
    outfil='/home/stgilhool/RV_projects/IRCS_rv/data/h2o_test/test5/h2otest.fits'
