pro template_caller2

;ircsrv_maketemplate, visualize=1, first_pix=0L, npix_select=512L, min_type='amoeba'



;ircsrv_maketemplate, visualize=0, first_pix=512L, npix_select=512L, min_type='amoeba'
npix=1024L
oversamp=7L
nexp=14L
...
for exp=0,nexp-1 do begin
    fhf=path+fbase+strtrim(exp,2)+'_0_511_Jun28allexp.fits'
    shf=path+fbase+strtrim(exp,2)+'_512_1023_Jun28allexp.fits'
    fh=mrdfits(fhf, 1)
    sh=mrdfits(shf, 1)
...
mwrfits, outstr, '../data/epoch/18Jan2011/temp_results/template_avg.fits', /create
