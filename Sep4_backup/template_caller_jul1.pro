pro template_caller_jul1, _EXTRA=ex
...
ircsrv_maketemplate_jul1, first_pix=0L, npix_select=512L, _EXTRA=ex



ircsrv_maketemplate_jul1, first_pix=512L, npix_select=512L, _EXTRA=ex
