pro template_caller_jul14, _EXTRA=ex
...
ircsrv_maketemplate_ksjul14, first_pix=0L, npix_select=512L, _EXTRA=ex
...
for exp=0,nexp-1 do begin
    fhf=path+fbase+strtrim(exp+1,2)+'_0_511_'+model_tag+'.fits'
