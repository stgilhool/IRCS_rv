pro IRCS_cal_control_lsftest, nparam_wl, nparam_gh, nparam_gh_lin, nparam_other, niter,sigma_start=sigma_start, random=random, wl_random=wl_random, gh_random=gh_random, gh_lin_random=gh_lin_random, other_random=other_random, wl_guess=wl_guess, gh_guess=gh_guess, gh_lin_guess=gh_lin_guess, other_guess=other_guess, min_type=min_type, visualize=visualize, oversamp=oversamp, model_func=model_func
...
wl_guess_all[2]=-1.983d-09 ;-2.063680d-9                   
wl_guess_all[3]=-1.69277d-12 ;-1.6401032d-12                  
wl_guess_all[4]=-7.7079d-20 ;-8.863d-17
wl_guess_all[5]=0d0
wl_guess_all[6]=0d0
                                ;Same for scale
...
gh_guess_all[0]=0d0;5.4801202d0	;guess for gaussian sigma
 gh_guess_all[1]=0d0;0.074284679d0
 gh_guess_all[2]=0d0;-0.12407160d0
 gh_guess_all[3]=0d0;-0.0014980603d0
 gh_guess_all[4]=0d0;-0.056740430d0
 gh_guess_all[5]=0d0;-0.0077393645d0
...
gh_lin_guess_all[1]=0d0;-2.7751771e-06
gh_lin_guess_all[2]=0d0;6.6262665e-05
gh_lin_guess_all[3]=0d0;8.4012060e-06
gh_lin_guess_all[4]=0d0;-1.2985736e-06
...
for run=0,niter-1 do begin
    ...
    fixed_sigma=sigma_start + (run*0.1)
    ;;;Wavelength parameters for amoeba
...
filename='model_'+model_id+'.fits'

path='~/RV_projects/IRCS_rv/cal_results/Oct31/'
...
IRCS_cal_lsftest, wl_guess, wl_scale, gh_guess, gh_scale, gh_lin_guess, gh_lin_scale, other_guess, other_scale, run,  niter, lin_switch=lin_switch, min_type=min_type, visualize=visualize, model_func=model_func, oversamp=oversamp
