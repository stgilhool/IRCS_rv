pro IRCS_cal_control_117, nparam_wl, nparam_gh, nparam_gh_lin, nparam_other, niter, random=random, wl_guess=wl_guess, gh_guess=gh_guess, gh_lin_guess=gh_lin_guess, other_guess=other_guess, min_type=min_type, visualize=visualize, model_func=model_func
...
IRCS_cal_117, wl_guess, wl_scale, gh_guess, gh_scale, gh_lin_guess, gh_lin_scale, other_guess, other_scale, run,  niter, lin_switch=lin_switch, min_type=min_type, visualize=visualize, model_func=model_func
