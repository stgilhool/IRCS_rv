pro q_wrap_big_jul14, make_template=make_template
...
if make_template then template_caller_jul14, _EXTRA=ex
...
q_wrap_jul14, first_first_pix=first_first_pix, pix_step=pix_step, model_out_tag=model_out_tag, _EXTRA=ex2
