...
;Read in Template
templatefile=templatepath+object+'_templatenew.dat'
...
rfile='/home/stgilhool/RV_projects/IRCS_rv/data/rvshift1_results/GJ273_18Jan2011_AB_0_127_new4norm_r2.fits'
f=mrdfits(rfile, 1)
re=f.result
...
norm_factor=norm_factor*tempnorm/tempnorm_new
plot, guess
stop
!p.multi=[0,1,2]
...
;if scaleiter eq 0 then stop
    ...
    outfil='/home/stgilhool/RV_projects/IRCS_rv/data/smooth_penalty_test/test18/penaltytest.fits'
