pro q_wrap_jul13, first_first_pix=first_first_pix, pix_step=pix_step, model_out_tag=model_out_tag, _EXTRA=ex2
...
for visit=0,13 do begin
    ...
    for i=0,3 do begin
        ...
        ircsrv_rvjul13, first_pix=first_pix, visit=visit, output_file=output_file, initial_file=initial_file, _EXTRA=ex2
