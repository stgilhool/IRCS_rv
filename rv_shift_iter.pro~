...
common rvinfo, wl_soln, wl_soln_full, samp_index, wl_soln_over_full, int_lab_over_full, int_obs, lsf, npix_lsf, npix_model, first_pix, npix_select, oversamp, norm_factor, err, visualize, npix_trim_start, npix_trim_end, min_type, nparam_other, last_guess, nlines, COwl_shift, telluric, tellwl, visit
...
telluric_depth=telluric^tell_depth
;shift lines and spline them onto soln
tellwl_shift=tellwl*(1d0+(tell_rv/bigc))
telluric_shift=interpol(telluric_depth, tellwl_shift, wl_soln_over_full)

;;;;;;;
;multiply and convolve
product_model=star_model*int_lab_over_full*telluric_shift
...
telluric_shift_avg=convol(telluric_shift, tophat)
...
telluric_shift_down=telluric_shift_avg[samp_index_full]
telluric_shift_dim=telluric_shift_down[first_pix:first_pix+npix_select-1]
...
;loadct, 12
    ...
    oplot, wl_soln, telluric_shift_dim+0.6d0
...
pro rv_shift_lines, epoch, object, trace, visualize=visualize, first_pix=first_pix, npix_select=npix_select, min_type=min_type
...
common rvinfo, wl_soln, wl_soln_full, samp_index, wl_soln_over_full, int_lab_over_full, int_obs, lsf, npix_lsf, npix_model, firstpix, npixselect, oversamp, norm_factor, err, visual, npix_trim_start, npix_trim_end, mintype, nparam_other, last_guess, nlines, COwl_shift, telluric, tellwl, visit
...
rv_scale=[100d0]
tellrv_scale=[100d0]
tell_depth_scale=[0.1d0]
stell_depth_scale=replicate(0.2d0, nlines)
stell_width_scale=replicate(1d-6, nlines)


guess=[rv_guess, tellrv_guess, tell_depth_guess, stell_depth_guess, stell_width_guess]
scale=[rv_scale, tellrv_scale, tell_depth_scale, stell_depth_scale, stell_width_scale]
