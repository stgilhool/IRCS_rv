function ircsrv_lsfold, gh0_vec, gh1_vec=gh1_vec, oversamp=oversamp, first_pix=first_pix, npix_select=npix_select, verbose=verbose, decomp=decomp
...
if n_elements(npix_select) eq 0 then npix_select=1024L-first_pix ;note this only works for 1024-pix
