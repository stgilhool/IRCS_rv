...
;Define mpfit constraints
  ...
  ;;; --- DELTA WL ---
    ...
    parinfo[delta_wl_index].step = [1d-14, 1d-18]*delta_wl_parscale
  ...
  ;;; --- GH0 ---
    ...
    if run eq 0 and s_iter eq 0 then begin
        parinfo[gh0_coeff_index].step = gh0step * gh0_parscale
