...
pro ircsrv_rvjul14, epoch=epoch, object=object, trace=trace, visualize=visualize, first_pix=first_pix, npix_select=npix_select, fmode=fmode, run=run, n_bases_lsf=n_bases_lsf, n_other=n_other, s_iter=s_iter, current_tag=current_tag, initial_file=initial_file, s_template_num=s_template_num, n_lsf_ga=n_lsf_ga, output_file=output_file, visit=visit, model_tag=model_tag
...
;bcv0=params1[0]
bcv0=params1[1] ;exp 0 is excluded, so now it's all relative to exp 1
