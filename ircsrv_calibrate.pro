...
;;;;;MAIN BODY;;;;;
;;;;;;;;;;;;;;;;;;;
pro ircsrv_calibrate, wl_guess, wl_scale, gh_guess, gh_scale, gh_lin_guess, gh_lin_scale, other_guess, other_scale, run, niter, lin_switch=lin_switch, min_type=min_type, visualize=visualize, oversamp=oversamp, npix_trim_start=npix_trim_start, npix_trim_end=npix_trim_end, model_func=model_func, first_pix=first_pix, npix_select=npix_select, object=object, epoch=epoch, trace=trace
