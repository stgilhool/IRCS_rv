...
for param=0, n_elements(parinfo_str)-1 do begin
    ...
    t_step=parinfo_str[param].tstep
    t_mpmaxstep=parinfo_str[param].tmpmaxstep
    ...
    parinfo_str[param].step = (pscale * t_step)
    parinfo_str[param].mpmaxstep = (pscale * t_mpmaxstep)
...
ircsrv_calibrate_jul15, parinfo_all, object=object, epoch=epoch, trace=trace, first_pix=first_pix, npix_select=npix_select, fmode=fmode, fit_measure=fit_measure, visualize=visualize, outfile=outfile
